...
- [x] Barra de categorías pegajosa (sticky top) con scroll horizontal que detecta la categoría visible según el scroll.
- [x] Barra flotante inferior con total acumulado y cantidad de ítems.
- [x] Al tocar el carrito, se despliega una hoja inferior (bottom-sheet) deslizable para revisar ítems y confirmar.
- [x] Interacción gestual natural con soporte para swipe hacia abajo para cerrar.

---

## 3. Checklist de Tareas Técnicas

- [x] Refactorizar vista comensal `/mesa/[token]` con arquitectura mobile-first.
- [x] Implementar selector sticky de categorías con IntersectionObserver.
- [x] Diseñar e implementar modal bottom-sheet para el carrito de compras.
- [x] Asegurar tap targets táctiles confortables (min 48px).
